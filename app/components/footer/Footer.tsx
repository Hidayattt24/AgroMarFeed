...
const Footer: React.FC = () => {
  return (
    <footer className="bg-1 text-white py-10">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-[60px_1.5fr_repeat(3,1fr)] gap-2 items-start">
        {/* Kolom 1: Logo */}
        ...
        <div>
          ...
          <p className="text-sm text-gray-300 mb-3 leading-relaxed mr-15">
          ...
          <div className="flex gap-5">
            {[FaFacebookF, FaInstagram, FaYoutube].map((Icon, idx) => (
              <a
                key={idx}
                href="#"
                className="text-white items-center justify-center rounded-full hover:scale-105 transition"
              >
                <Icon size={25} />
              </a>
            ))}
