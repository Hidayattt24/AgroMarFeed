...
function HeroBannerTwo() {
  return (
    <section className="bg-gradient-to-r from-green-700 to-green-900 text-white lg:py-8">
      <div className="max-w-screen-xl mx-auto relative overflow-hidden py-16 grid grid-cols-1 lg:grid-cols-3 gap-6 p-4 lg:p-8">
          ...
          <div className="flex flex-col-reverse md:flex-row items-center">
            <div className="lg:w-full text-center md:text-start">
              <h1 className="text-4xl md:text-6xl font-bold mb-4 mt-2 md:mt-0">
                Solusi Pakan Berkelanjutan untuk Peternakan Modern
              </h1>
              <p className="text-lg lg:text-xl mb-8">
                Temukan produk pakan ramah lingkungan dari limbah agro-maritim
              </p>
        ...
        >
          <h2 className="text-3xl font-bold">Promo Musim Panen</h2>
          ...
          <p className="my-4 text-lg font-medium">
            Diskon hingga <span className="text-rose-500 text-xl">( 50% )</span>{" "}
            untuk produk pakan pilihan!
          </p>
          <Link
            href={"/shop?category=Pakan"}
