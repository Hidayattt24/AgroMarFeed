...
const BannerTwo = () => {
  return (
    <section className="bg-gradient-to-b from-green-800 to-green-600 dark:bg-gray-900">
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                  <span className="block xl:inline">Pakan Inovatif untuk</span>{" "}
                  <span className="block text-blue-400 dark:text-blue-500 xl:inline">
                    Ternak dan Perikanan
                  </span>
                </h1>
                <p className="mt-3 text-base text-gray-200 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Dari limbah menjadi manfaat — dukung peternakan berkelanjutan
                  hari ini dengan AgroMarFeed.
                </p>
